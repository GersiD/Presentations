...
There is a vast field of research that focuses on developing risk measures \todo{Cite something}~\cite{howard1972}. The goal of a risk measure is to quantify the uncertainty of a random variable, often while being interpretable and computationally tractable. The intersections of risk and reinforcement learning is the topic of this review, where we will explore the field of risk-averse reinforcement learning.
...
\todo{I think this paragraph needs alot of work especially in the motivation}
...
\todo{I have to stop here because I don't really know if what I said above makes sense or is true since tower property is not satisfied by all coherent risk measures.}
